...
OS_VERSION=`echo ${BOOTLOADER:8:1} | tr ABCDEFGH 12345678`
...
if [ "$OS_VERSION" -ge 4 ]; then
  ...
  ln -s /vendor/lib64/skm-13 /vendor/lib64/libkeymaster4.so
else
  ...
  ln -s /vendor/lib64/skm-12 /vendor/lib64/libkeymaster4.so
fi;
